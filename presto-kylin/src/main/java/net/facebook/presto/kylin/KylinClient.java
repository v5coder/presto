package net.facebook.presto.kylin;
...
public class KylinClient extends BaseJdbcClient {
    ...
    @Inject
    public KylinClient(JdbcConnectorId connectorId, BaseJdbcConfig config, KylinConfig mySqlConfig)
            throws SQLException {
        super(connectorId, config, "`", connectionFactory(config, mySqlConfig));
    }

    private static ConnectionFactory connectionFactory(BaseJdbcConfig config, KylinConfig mySqlConfig)
            throws SQLException {
    ...
    public PreparedStatement getPreparedStatement(Connection connection, String sql)
        ...
        if (statement.isWrapperFor(Statement.class)) {
            statement.unwrap(Statement.class).getResultSet();
        }
        return statement;
    }
