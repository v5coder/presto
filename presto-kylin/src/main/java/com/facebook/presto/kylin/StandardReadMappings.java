...
import static com.facebook.presto.kylin.ReadMapping.longReadMapping;
import static com.facebook.presto.kylin.ReadMapping.sliceReadMapping;
...
public final class StandardReadMappings
{
    ...
    public static Optional<ReadMapping> kylinTypeToPrestoType(KylinTypeHandle type)
    {
        int columnSize = type.getColumnSize();
        switch (type.getKylinType()) {
            case Types.BIT:
            case Types.BOOLEAN:
